...
<% 
  ...
  String targetReferer = "https://umass-pilot.blackboard.com";
...
<div id="pagewrap">
  ...
  <section id="contentLeft">
    <div class="uma-loginbox">
      <div class="uma-logintitle">
        <h2>Login to Blackboard Ultra Pilot</h2>  
      </div>
  ...
  <footer>
    ...
    <div class="footdisclaimer">        
      <p>©2019 University of Massachusetts&nbsp;•&nbsp;<a href="http://umass.edu/site-policies" target="_blank">Site Policies</a>
...
<script type="text/javascript">  
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-793538-20']);
