...
<div align="center">
	<div class="main">
		<div class="top">
			<div id="logo">
				<a href="http://www.umassonline.net/" title="Home" rel="home"><img src="https://uma.umassonline.net/bbcswebdav/library/login/uma/images/template/header.gif" usemap="#headermap" /></a>
			</div>
			<div id="header-right">
				<div id="social-media">
					<div class="icon"><a href="http://www.facebook.com/MyUMassOnline" title="Visit UMassOnline on Facebook" target="_blank"><img src="https://uma.umassonline.net/bbcswebdav/library/login/uma/images/template/facebook.png" alt="Facebook icon" ></a></div>
					<div class="icon"><a href="http://www.linkedin.com/company/86671" title="Visit UMassOnline on LinkedIn" target="_blank"><img src="https://uma.umassonline.net/bbcswebdav/library/login/uma/images/template/linkedin.png" alt="LinkedIn icon" ></a></div>
					<div class="icon"><a href="http://twitter.com/MyUMassOnline" title="Visit @MyUMassOnline on Twitter" target="_blank"><img src="https://uma.umassonline.net/bbcswebdav/library/login/uma/images/template/twitter.png" alt="Twitter icon" ></a></div>
					<div class="icon"><a href="http://www.umassonline.net/blog" title="Visit Blog" target="_blank"><img src="https://uma.umassonline.net/bbcswebdav/library/login/uma/images/template/blog.png" alt="Blog icon" ></a></div>
					<div class="icon"><a href="http://www.pinterest.com/umassonline/" title="Visit UMassOnline on Pinterest" target="_blank"><img src="https://uma.umassonline.net/bbcswebdav/library/login/uma/images/template/pinterest.png" alt="Pinterest icon" ></a></div>
				</div>
			</div>
		</div>
        ...
        <tr>
          ...
          <td class="rightcol">
            ...
            <div class="block">
              ...
              <p><a href="http://www.umassonline.net/contact-us"><img height="38" alt="UMass Online - Can't find something?" width="180" border="0" src="https://uma.umassonline.net/bbcswebdav/library/login/uma/images/buttons/need-help.jpg" /></a></p>
            </div>
          </td>
        </tr>
      </table>     
...
<bbNG:cssBlock>
<link rel="stylesheet" type="text/css" href="https://uma.umassonline.net/bbcswebdav/library/login/uma/css/styles.css" />
<style type="text/css">
tr:nth-child(2n) {
