...
<html  lang="en-US"> 
 <head>
  ...
  <link rel="SHORTCUT ICON" type="image/x-icon" href="/ui/bb-icon2.ico">
    <link rel="stylesheet" type="text/css" href="/common/shared.css?v=9.1.120113.0-3" id="css_0">
    <link rel="stylesheet" type="text/css" href="/themes/as_2012/theme.css?v=9.1.120113.0-3" id="css_1">
      <link rel="stylesheet" type="text/css" media="print" href="/ui/styles/print.css?v=9.1.120113.0-3">
    <script type="text/javascript" src="/javascript/i18n.js?v=9.1.120113.0-3"></script>
...
function _init_bundle_LOCALE_SETTINGS() {
    ...
    LOCALE_SETTINGS['float.allow.negative.format'] = '^([-]?[0-9]{1,3}(,[0-9]{3})*(.[0-9]+)?|.[0-9]+)?$';
...
_init_bundle_LOCALE_SETTINGS();
         ...
         <script type="text/javascript" src="/javascript/prototype.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/fastinit.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/ngui/page.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/validateForm.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/numberLocalizer.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/accessibleSelect.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/popup.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/webapps/portal/dwr_open/interface/MashupDWRFacade.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/esapi4js/esapi-compressed.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/esapi4js/resources/i18n/ESAPI_Standard_en_US.properties.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/esapi4js/resources/Base.esapi.properties.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/titlebartagutils.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/browserSpecificBehavior.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/scriptaculous/effects.js?v=9.1.120113.0-3"></script>
    <script type="text/javascript" src="/javascript/quick_links.js?v=9.1.120113.0-3"></script>
    </head>
  <body >
  
<div class="locationPane">
 <div id="contentPanel" class="contentPaneWide error">
...
<div id="pageTitleBar" class='pageTitleIcon' tabindex="0">
  ...
  <span style="color:;">Access Denied</span>  </span></h1>
     ...
     <div id="bbNG.receiptTag.content" tabindex="0">  <strong>Access Denied</strong><br> Either you are not logged in or you do not have the appropriate privileges to perform this action. </div><p><span class="receiptDate">Friday, January 31, 2014 7:49:57 PM EST</span></p><p class="taskbuttondiv" id="bottom_submitButtonRow">
			<input  class="button-2" type="button" name="bottom_Cancel" value="Cancel" onclick="document.location='javascript:history.go(-1)';">
		<input  class="submit button-1" name="bottom_Log In" type="submit" value="Log In" onClick="document.location='/webapps/login?action=relogin';">
  ...
  <script type="text/javascript">page.bundle.addKey('display.play','Play');page.bundle.addKey('yt.paused','Paused:');page.bundle.addKey('yt.buffering','Buffering:');page.bundle.addKey('display.volumeDown','Volume Down');page.bundle.addKey('lightbox.overlay','{0} has been opened as a lightbox overlaying the current page.');page.bundle.addKey('inlineconfirmation.refresh','Refresh');page.bundle.addKey('yt.cued','Cued:');page.bundle.addKey('hidden.link.close.form','End of form. Click to return to associated item.');page.bundle.addKey('yt.stopped','Stopped:');page.bundle.addKey('hidden.link.close.menu','End of menu. Click to return to associated item.');page.bundle.addKey('display.playerControls','Player Controls');page.bundle.addKey('display.of','of');page.bundle.addKey('display.view.on.flickr','View Photo on Flickr');page.bundle.addKey('yt.mute','Mute');page.bundle.addKey('common.pair.paren','{0} ({1})');page.bundle.addKey('lightbox.loading','Loading...');page.bundle.addKey('frameset.contentframe.title','Content');page.bundle.addKey('inlineconfirmation.close','Close');page.bundle.addKey('display.videoStatus','Video Status');page.bundle.addKey('yt.ended','Ended:');page.bundle.addKey('display.videoPlayerControls','Video Player Controls');page.bundle.addKey('mashups.content.data.msg','We are unable to display the mashup content. This happens if the system detects an invalid URL. Remove the mashup item and try again to resolve this issue.');page.bundle.addKey('yt.play','Play');page.bundle.addKey('yt.playing','Playing:');page.bundle.addKey('yt.unmute','Unmute');page.bundle.addKey('display.embeddedVideoPlayer','Embedded Video Player');page.bundle.addKey('display.closePlayerControls','Close Player Controls');page.bundle.addKey('display.volumeUp','Volume Up');page.bundle.addKey('contextmenu.frame.title','Menu frame');page.bundle.addKey('display.stop','Stop');page.bundle.addKey('display.mute','Mute');page.bundle.addKey('yt.pause','Pause');</script>
